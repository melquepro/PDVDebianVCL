object FrmConsProduto: TFrmConsProduto
  ...
  object pnlFundo: TPanel
    ...
    object EdtDesCod: TEdit
      ...
      ParentFont = False
      TabOrder = 0
      TextHint = 'Pesquise por descri'#231#227'o ou c'#243'digo'
      OnKeyDown = EdtDesCodKeyDown
      OnKeyPress = EdtDesCodKeyPress
    end
  end
  ...
  object FDQuery1: TFDQuery
    ...
    object FDQuery1codbarra: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'codbarra'
      Origin = 'codbarra'
      FixedChar = True
    end
    object FDQuery1descproduto: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'descproduto'
      Origin = 'descproduto'
      Size = 30
    end
    object FDQuery1vlrproduto: TBCDField
      AutoGenerateValue = arDefault
      FieldName = 'vlrproduto'
      Origin = 'vlrproduto'
      DisplayFormat = '##,###,###.00'
    ...
    object FDQuery1medida: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'medida'
      Origin = 'medida'
      FixedChar = True
