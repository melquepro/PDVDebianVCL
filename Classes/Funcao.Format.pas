...
uses System.SysUtils, FMX.Edit, Vcl.StdCtrls, Classes, System.MaskUtils;
...
begin
    ...
    try
        Result := FormatFloat('#,###.00', strtofloat(str) / 100);
    except
...
begin
    ...
    try
        Result := FormatFloat('#,###.000', strtofloat(str) / 1000);
    except
        Result := FormatFloat('#,###.000', 0);
    end;
end;
